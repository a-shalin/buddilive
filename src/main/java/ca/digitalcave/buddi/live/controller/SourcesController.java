...
public class SourcesController {
	...
	public String get(@AuthenticationPrincipal User user, @PathVariable String direction) {
		try {
			...
			for (String key : accountTypeMap.keySet()) {
				final AccountType at = accountTypeMap.get(key);
	...
	private void insertCategories(JSONObject result, List<Category> categories, User user, int depth) throws CryptoException {
		final StringBuilder sb = new StringBuilder();

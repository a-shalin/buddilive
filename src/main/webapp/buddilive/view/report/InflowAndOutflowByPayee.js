Ext.define('BuddiLive.view.report.InflowAndOutflowByPayee', {
	extend: "Ext.panel.Panel",
	alias: "widget.reportinflowandoutflowbypayee",
	...
	initComponent: function(){
		...
		this.title = BuddiLive.translate("REPORT_TABLE_INFLOW_AND_OUTFLOW_BY_PAYEE") + " - " + this.initialConfig.options.dateRange;
		...
		this.items = [
			{
				...
				store: Ext.create("Ext.data.Store", {
					...
					proxy: {
						type: "ajax",
						url: "data/report/inflowandoutflowbypayee.json?" + this.initialConfig.options.query,
						reader: {
							type: "json",
							rootProperty: "data"
						}
